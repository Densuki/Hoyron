...
module.exports = {
  ...
  //if (!message.member.roles.some(r=>["STAFF"].includes(r.name))) return message.reply("Você não pode fazer isso! Você não possui permissões para executar esse comando!");
